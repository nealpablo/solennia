...
export default function VenueDetail() {
  ...
  const handleChatClick = () => {
    ...
    if (!venue.firebase_uid) {
      console.error("Venue missing firebase_uid:", venue);
      toast.error("Unable to start chat with this venue");
      return;
    }

    navigate(`/chat?to=${encodeURIComponent(venue.firebase_uid)}`);
  };
        ...
        <div className="lg:col-span-2">
          ...
          {activeTab === "overview" && (
            <div className="prose max-w-none">
              <h3 className="text-base sm:text-lg font-semibold mb-3">About This Venue</h3>
          ...
          {activeTab === "packages" && (
            <div className="space-y-4">
              <h3 className="text-base sm:text-lg font-semibold mb-4">Available Packages</h3>
          ...
          {activeTab === "amenities" && (
            <div>
              <h3 className="text-base sm:text-lg font-semibold mb-4">Venue Amenities</h3>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 sticky top-4">
            ...
            <button 
              ...
              className="w-full bg-[#7a5d47] hover:bg-[#654a38] text-white font-semibold py-2.5 sm:py-3 text-sm sm:text-base rounded-lg transition-colors mb-3 flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button 
              className="w-full bg-[#e8ddae] hover:bg-[#dbcf9f] text-gray-800 font-semibold py-2.5 sm:py-3 text-sm sm:text-base rounded-lg transition-colors mb-3"
            >
              Send Inquiry
            </button>
            
            <button 
              className="w-full border-2 border-[#e8ddae] hover:bg-[#e8ddae]/10 text-gray-800 font-semibold py-2.5 sm:py-3 text-sm sm:text-base rounded-lg transition-colors"
            >
              Schedule Visit
            </button>
          </div>
